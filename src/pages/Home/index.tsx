...
import carousel_hallsan from "../../assets/images/home_hallasan.jpg";
import carousel_suwolbong from "../../assets/images/home_suwolbong.jpg";
import carousel_kaist from "../../assets/images/home_KAIST.jpg";

import project_fourierhandflow from "../../assets/images/project_fourierhandflow.png";
import project_contour_tracking from "../../assets/images/project_contour_tracking.png";
import project_FNA from "../../assets/images/project_FNA.png";
import project_ksum2023 from "../../assets/images/project_ksum2023.png";
import project_MQP_2022 from "../../assets/images/project_MQP_2022.png";
    ...
    <div id="header" className="carousel slide" data-ride="carousel">
      ...
      <div className="carousel-inner">
        <div className="carousel-item active">
            <img src={carousel_hallsan} className="d-block w-100" alt="Jeju Island Hallasan" />
            <div className="carousel-caption d-none d-md-block">
                <small className="text-light">Hallsan, Jeju, South Korea (7/22/2022)</small>
            </div>
        </div>
        <div className="carousel-item">
            <img src={carousel_suwolbong} className="d-block w-100" alt="Jeju Island Suwolbong" />
            <div className="carousel-caption d-none d-md-block">
                <small className="text-light">Suwolbong, Jeju, South Korea (7/20/2022)</small>
            </div>
        </div>
        <div className="carousel-item">
            <img src={carousel_kaist} className="d-block w-100" alt="KAIST N1 building" />
            <div className="carousel-caption d-none d-md-block">
        ...
        <div className="container">
            ...
            <div className="row">
                <div className="col-lg-4" style={{textAlign: "center"}}>
                    <img className="avatar avatar-circle pb-3" src={profile_junbong} alt="my face" />
                    <div>
                        <h2>Junbong Jang</h2>
    ...
    <div id="projects" className="basic-3">
        <div className="container">
            ...
            <div className="row mb-5">
                <div className="col-lg-4">
                    <div className="image-container">
                        <img className="img-fluid" src={project_fourierhandflow} alt="Fourier Hand Flow" />
                    </div> {/* end of image-container */}
                </div>
            ...
            <div className="row mb-5">
                <div className="col-lg-4">
                    <div className="image-container">
                        <img className="img-fluid" src={project_contour_tracking} alt="CVPR 2023 project" />
                    </div> {/* end of image-container */}
                </div>
            ...
            <div className="row mb-5">
                <div className="col-lg-4">
                    <div className="image-container">
                        <img className="img-fluid" src={project_FNA} alt="project FNA" />
                    </div> {/* end of image-container */}
                </div>
            ...
            <div className="row mb-5">
                <div className="col-lg-4">
                    <div className="image-container">
                        <img className="img-fluid" src={project_ksum2023} alt="KSUM 2023" />
                    </div> {/* end of image-container */}
                </div>
            ...
            <div className="row mb-5">
                <div className="col-lg-4">
                    <div className="image-container">
                        <img className="img-fluid" src={project_MQP_2022} alt="project MQP 2022" />
                    </div> {/* end of image-container */}
                </div>
            ...
            <div className="row mb-5">
                <div className="col-lg-4">
                    <div className="image-container">
                        <img className="img-fluid" src={project_marsnet} alt="marsnet" />
                    </div> {/* end of image-container */}
                </div>
